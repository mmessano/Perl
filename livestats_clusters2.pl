...
my ( $clusters, $dir, @files, $file, $logdirs, $logdirstext, $logdirstext1, $logdirstext2, $loginID, $loginIDtext, $name, $nametext, $newrow, $path, $twig, $serverID, $url, $urltext );
...
@files = (readdir DIR);
	   foreach $file ( @files ) {
		   unless ( $file =~ /^\.+/ ) {
			   ...
			   if ( $DSN->Sql( $SQL . "'" . $loginIDtext . "'" . "," . "'" . $urltext . "'" . "," . "'" . $logdirstext1 . "'"  . "," . "'" . $logdirstext2 . "'" ) )
                        {
